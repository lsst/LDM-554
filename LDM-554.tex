...
\subsubsection{Access to Image and Visit Metadata: ObsTAP}
...
\subsubsection{Access to Image and Visit Metadata: CAOM2}  % ADDED FOR RFC-652 IMPLEMENTATION

\label{DMS-API-REQ-xx06-RFC-652}
\textbf{ID:} DMS-API-REQ-xx06-RFC-652
