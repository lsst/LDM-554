...
\textbf{Discussion:}  % ADDED FOR RFC-652 IMPLEMENTATION
The SIA service should present the same ObsCore view of the image and visit metadata that is provided by the ObsTAP service (see DMS-API-REQ-0022), subject to the restriction on dataproduct_type from Section 2.1.14 of the SIAv2 standard.
...
\paragraph{VOTable Output for TAP}\hfill  % Force subsequent text onto new line
